...
RecipientDevice->+Server: 11 submit temp pub key(B) + original data hash
Server-->-RecipientDevice: 12 OK / data original hash
RecipientDevice->RecipientDevice: 13 Display QR code (data original hash)
RecipientDevice->+Server: 14 poll for encrypted pass(B) by data original hash
IdentityDevice->RecipientDevice: 15 scan qr code for original hash
IdentityDevice->+Server: 16 get credentials by data original hash from QR
...
IdentityDevice->+Server: 21 submit encrypted pass(B) + pass hash + data original hash
Server-->-IdentityDevice: 22 OK / data original hash
...
RecipientDevice->+Server: 28 validate decryptedDataHash
